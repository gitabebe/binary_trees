...
This repository contains programs written for the alx low level programming - Binary trees project
...
* [binary_trees.h](./binary_trees.h): Header file containing prototypes for all functions written in the project.

### Test Files

* [tests](./tests): Folder of test files containing main.c files and -putchar.c.
  * [main.c](./tests): files used to test functions
  * [binary_tree_print.c](./binary_tree_print.c): C function that prints binary trees in a pretty way. [Source](./https://github.com/alx-tools/0x1C.c)
